...
`skills/automation-*/SKILL.md` or `skills/platform/aap-*/SKILL.md` files.
...
- *Read AGENTS.md. Operate in Mode 1: The Auditor. Follow skills/automation-auditor/SKILL.md.*
- *Read skills/automation-builder/SKILL.md. Create a new role under deliveries/automation/roles/.*
