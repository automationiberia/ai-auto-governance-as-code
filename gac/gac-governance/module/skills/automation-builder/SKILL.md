...
| Wire type playbook to Controller (live AAP, after Git exists) | [automation-controller-ops](../automation-controller-ops/SKILL.md) → `aap-job-template-create` (Phase 2) |
