...
| **`gac/module/skills/`** | Lola module skills (`SKILL.md` per skill) | AI enforcement layer (Librarian-synced) | Internal |
| **`gac/module/commands/`** | Lola slash commands (`/audit`, `/build`, …) | Mode entry points | Internal |
...
│  ┌────────────────────┐    ┌─────────────────────────────┐ │
│  │ automation-whitepaper │──│ gac/module/ + AGENTS.md     │ │
