...
- Never run `git push` automatically; only push when the user explicitly asks. Show push commands for manual use per [AGENTS.md](../../AGENTS.md#git-workflow-agents).
