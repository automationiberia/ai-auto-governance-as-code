...
Git submodule inside the **`ai-auto-governance-as-code`** governance monorepo. Production **roles** and **type playbooks** live here — separate from the white book and from governance skills (`gac/gac-*/module/skills/`).
