...
**AI Mob Design:** [automation-whitepaper/guides/ai-mob-design.md](automation-whitepaper/guides/ai-mob-design.md) · [gac/gac-design/module/skills/ai-mob-design/SKILL.md](gac/gac-design/module/skills/ai-mob-design/SKILL.md).
...
|------|------|----------------------|----------------|
| **1 — The Auditor** | Retroactive | Scan existing playbooks and roles for technical debt. | Gap analysis: legacy patterns (e.g. `with_items`), missing variable prefixes, bare `item`, non-FQCN modules; output findings and remediating diffs aligned with `gac/gac-*/module/skills/*/SKILL.md` and the white paper. |
| **2 — The Builder** | Proactive | Generate net-new automation or refactor to full compliance. | Bootstrap from **this file** and [gac/gac-governance/module/skills/automation-builder/SKILL.md](gac/gac-governance/module/skills/automation-builder/SKILL.md); ensure FQCN, L/T/F/C placement, and collection layout from the first line of YAML. |
...
|-------------|------|----------------|
| Review, lint fix, refactor, PR comment on existing YAML | **1 — Auditor** | [automation-auditor](gac/gac-governance/module/skills/automation-auditor/SKILL.md) |
| New capability, greenfield role/playbook, extend OS platform | **2 — Builder** | [automation-builder](gac/gac-governance/module/skills/automation-builder/SKILL.md) + task skills below |
| Sync skills with white paper, GPA submodule, new governance pattern | **3 — Librarian** | [automation-librarian](gac/gac-governance/module/skills/automation-librarian/SKILL.md) |

Task skills (use **inside** Builder or Auditor modes as needed): see [gac/README.md](gac/README.md).

**Platform administration** (live AAP via MCP): `gac/gac-aap-platform/module/skills/` — see [aap-platform-administration.md](automation-whitepaper/operations/aap-platform-administration.md). Declare **platform area** (Audit / Operate / Build / Maintain) in addition to content modes when operating live AAP.

---

## Skill planes

| Plane | Modules | Domain |
|-------|---------|--------|
| **Content governance** | `gac-governance`, `gac-design`, `gac-architecture`, `gac-development`, `gac-quality` | Ansible in Git (roles, playbooks, collections) |
| **Platform administration** | `gac-aap-platform` | Live AAP objects via MCP |
...
| **3 — AI encoding** | `gac/gac-*/module/skills/*/SKILL.md` + this file | Operationalizes 1–2 for AI; must match white book |
...
automation-whitepaper/     ← Guide-first standards (human-authored; wins on conflict)
        ↓ Librarian sync
gac/gac-governance/module/skills/    ← modes (Auditor, Builder, Librarian)
gac/gac-{design,architecture,development,quality}/  ← content skills
gac/gac-aap-platform/module/skills/  ← platform AI operationalization (MCP)
